...
2. Crea un nuevo archivo en el directorio `fintech-accelator/scripts/dml/insert/` llamado `02-insert-clients-transactions.sql` y copia el contenido del archivo disponible en el [repositorio GitHub](https://github.com/Doc-UP-AlejandroJaimes/sql-101-mastering/tree/main/content/fintech-accelator/scripts/dml/insert).
...
¡Buena suerte, explorador de datos! El mundo financiero espera ser descubierto a través de tus consultas.ntico maestro de las consultas.
...
## 💻 DESAFÍO PRINCIPAL: DOMINA LAS CONSULTAS ESENCIALES
Cre el directorio `fintech-cards-intermediate-queries` en la siguiente ruta:
```
fintech-accelator/scripts/dml/select/fintech-cards-intermediate-queries/
```

Ahora los siguientes archivos para organizar tus consultas:
```
/fintech-cards-intermediate-queries/01-basic-joins.sql
/fintech-cards-intermediate-queries/02-aggregation-functions.sql
/fintech-cards-intermediate-queries/03-group-by-clauses.sql
```

**Nota**: Para cada reto, dejaré una de las n consultas hechas, como validación del proceso.


### 🔄 NIVEL 1: MAESTRO DE LOS JOINS (01-basic-joins.sql)

Tu misión es crear las siguientes consultas en el archivo llamado `01-basic-joins.sql`:
...
### 📊 NIVEL 2: DOMADOR DE AGREGACIONES (02-aggregation-functions.sql)

Realiza en el archivo `02-aggregation-functions.sql` las siguientes misiones:
...
### 🧩 NIVEL 3: ESTRATEGA DE GRUPOS (03-group-by-clauses.sql)

Crea el archivo `03-group-by-clauses.sql` con los siguientes desafíos:
...
¡Buena suerte, explorador de datos! El mundo financiero espera ser descubierto a través de tus consultas.